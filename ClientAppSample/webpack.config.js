    ...
    const sharedConfig = () => ({
        ...
        module: {
            ...
            rules: [
                ...
                // },
                {
                    include: path.join(__dirname, "./ClientApp/boot-client.tsx"), // This indicates files that should be included. IF directory is given, sub files, directories are selected. https://webpack.js.org/configuration/module/#condition
                    use: 'awesome-typescript-loader?silent=true' // What loader should be used for matched files. https://webpack.js.org/configuration/module/#rule-use
                },
                {
